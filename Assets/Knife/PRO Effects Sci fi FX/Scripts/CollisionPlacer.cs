...
namespace Knife.Effects
{
    ...
    public class CollisionPlacer : MonoBehaviour, ICollisionHandler/*, IAutoPlacer*/
    {
        ...
        [SerializeField] private bool rotateAlongNormal = false;
        ...
        public void CollisionEnter(Collision collision)
        {
            ...
            if(rotateAlongNormal)
                transform.rotation = Quaternion.AngleAxis(Random.value * 360, normal) * Quaternion.LookRotation(Vector3.forward, normal);
        }
