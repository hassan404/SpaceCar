...
namespace ChobiAssets.PTS
{
	...
	[ CustomEditor (typeof(PTS_Track_Deform_CS))]
	public class PTS_Track_Deform_CSEditor : Editor
	{
		...
		void Set_Vertices ()
		{
            ...
            {
                PTS_Track_Deform_CS deformScript = thisTransform.GetComponent<PTS_Track_Deform_CS>();
